...
const buttonStyles =
  'block mr-2 py-3 px-4 text-gray-900 rounded-xl hover:bg-gray-100 md-hover-bg-transparent transition-all duration-200 ease-in-out';
                ...
                <div className="relative">
                  ...
                  {showDropdown && (
                    <div className="absolute bg-white border border-gray-300 rounded-lg translate-x-[-35px]">
                      ...
                      <button
                        className="py-3 px-4 w-full text-gray-900 hover:bg-gray-100 md-hover-bg-transparent transition-all duration-200 ease-in-out"
