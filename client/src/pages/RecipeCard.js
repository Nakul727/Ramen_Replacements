...
function Recipe() {
  ...
  return (
    <div>
      ...
      {isLoggedIn ? (
        <div
          className="body_sections overflow-hidden pt-20"
          style={{ backgroundColor: 'rgb(255, 220, 220)' }}
        >
          {recipe ? (
            <div
              className="p-12 mx-20 mb-12 border-2 border-black rounded-3xl"
            ...
            >
              ...
              <div className="flex items-center justify-center p-4 bg-zinc-200 mt-8">
                <p>Like the Recipe</p>
                <button
                  className="font-arvo bg-white rounded-3xl hover:bg-slate-200 p-4 ml-12"
                  onClick={handleLike}
                >
                  Like
                </button>
