  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        displayMessage(
          'registration-result',
          'Authentication failed. Please check your credentials or sign up.',
        );
      }
    } catch (error) {
        ...
        <div className="body_sections overflow-hidden pt-20">
          ...
          >
            ...
            <div className="px-32 mt-24">
              ...
              />
              {usernameError && (
                <p className="text-red-500 text-xs mt-1 font-arvo">{usernameError}</p>
              )}
            </div>
            ...
            <div className="px-32 mt-4">
              <label
                htmlFor="password"
                className={`font-arvo text-sm text-gray-600 mb-2 ${passwordError ? 'text-red-500' : ''}`}
              >
                Password*
              </label>
              <input
              ...
              />
              {passwordError && (
                <p className="text-red-500 text-xs mt-1 font-arvo">{passwordError}</p>
              )}
            </div>
